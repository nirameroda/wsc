...
def parameter_parser():
    ...
    parser.add_argument("--input",
                        nargs="?",
                        default="./data/zachary.csv",
	                help="Input graph path.")
                    
    parser.add_argument("--content",
                       nargs="?",
                        default="./data/zachimp.csv",
	               help="content graph path.")
    parser.add_argument("--kshell",
                       nargs="?",
                        default="./data/zachkshell.csv",
	               help="kshell graph path.")
    parser.add_argument("--assignment-output",
                        nargs="?",
                        default="./output/edge.json",
